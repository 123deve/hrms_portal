...
const JobDetail = () => {
  return (
    ...
    <div className='border-2 md:mt-5'>
        <h1 className='border-b-2 py-4 px-4 text-sm md:text-lg'>Job Details</h1>
        <div className='md:flex p-2 m-6 mb-10 md:mb-20 md:mt-10 text-sm justify-between font-light'>
    ...
    <div className='border-2 md:mt-5'>
        <h1 className='border-b-2 py-4 px-4 text-sm md:text-lg'>EMPLOYEE TIME</h1>
    ...
    <div className='border-2 md:mt-5'>
        <h1 className='border-b-2 py-4 px-4 text-sm md:text-lg'>OTHER</h1>
        <div className='md:flex p-2 m-6 mb-10 md:mb-20 mt-6 md:mt-10 text-sm justify-between font-light'>
